...
public class Producers {
     ...
     */
    @Identifier("amq")
    JmsComponent amq(JtaTransactionManager tm) {
        ConnectionFactory cf = new org.apache.activemq.artemis.jms.client.ActiveMQXAConnectionFactory("tcp://artemis:61616", "artemis", "artemis");
